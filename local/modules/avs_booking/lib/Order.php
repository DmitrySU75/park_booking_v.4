...
class Order
{
    ...
    public static function getLogs($orderId = null, $limit = 100)
    {
        global $DB;

        $sql = "SELECT * FROM avs_booking_log";
        if ($orderId) {
            $sql .= " WHERE ORDER_ID = " . intval($orderId);
        }
